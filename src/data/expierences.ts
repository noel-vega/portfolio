...
export const expieriences: Expierience[] = [
  {
    company: {
      name: "Revia.ai",
      industry: "Legal Tech",
  ...
  },
  {
    ...
    techstack: ["AWS", "Angular", "Typescript", "Python", "Flask", "Docker", "Nginx"]
  },
  {
    ...
    techstack: ["Powershell", "React", "Typescript", "Python", "Flask", "SQL Server", "Power BI"]
  }
]
